...
tags:
  ...
  - 코어자바스크립트
  - 스터디
summary: 'call, apply, bind 메서드의 사용법과 차이점, 화살표 함수의 this 바인딩 특성'
draft: false
---

코어 자바스크립트 스터디 **6주차** 내용을 정리했습니다. 이번 주제는 **call, apply, bind, 화살표 함수**입니다.
...
function introduce(age, hobby) {
  console.log(`안녕하세요, 저는 ${this.name}이고 ${age}살이며 ${hobby}를 좋아합니다.`)
}
