...
tags:
  ...
  - 코어자바스크립트
  - 스터디
summary: 'JavaScript의 this 바인딩 규칙과 호출 방식에 따른 동작, call/apply/bind 메서드 활용법'
draft: false
---
...
function 자기소개(나이, 취미) {
  console.log(`안녕하세요, 저는 ${this.이름}이고 ${나이}살이며 ${취미}를 좋아해요.`)
}
...
**기억하기!**: this는 함수가 정의될 때가 아니라 호출될 때 결정됩니다!
